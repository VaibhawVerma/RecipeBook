        ...
        <div className="container mx-auto py-8 px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto bg-white p-6 sm:p-8 rounded-2xl shadow-xl">
                ...
                <div className="flex flex-wrap items-center justify-between mb-6 gap-4">
                    <p className="text-md text-gray-500">By: <span className="font-medium text-indigo-600">{recipe.author}</span></p>
                ...
                <div className="bg-gray-50 p-6 rounded-lg mb-8">
                    <h3 className="text-lg font-semibold text-gray-800 mb-2">
                        {isAuthor ? "This is your recipe" : (userRating > 0 ? "You rated this recipe" : "Rate this recipe")}
                    </h3>
